...
1. What are the main differences between a stateful and a functional class?
   The literal difference is that one has state, and the other doesn’t. That means the stateful components are keeping track of changing data while functional class always render the same thing.
2. When does a componentWillMount function be called? What about a componentWillUpdate?
   On the First Render or Birth Phase. Component did update in the Update phase of the lifecycle
3. Define stateful logic.
   logic that has todo with state
4. What are the three step of creating a successful test? What is done in each phase?
   I forgot the name of the first A - in this you would render your component
   In Act- you would like type into an input field and
   In assert- you would check to see that you expect something like expect().toBeNull()
